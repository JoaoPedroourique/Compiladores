...
#line 106 "calc.tab.c" /* yacc.c:355  */
...
#line 133 "calc.tab.c" /* yacc.c:355  */
};
...
#line 150 "calc.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "NUMBER", "PLUS", "TIMES", "LEFT",
  "RIGHT", "END", "END_OF_FILE", "$accept", "Input", "Line", "E", "T", "F", YY_NULLPTR
};
#endif
...
#line 41 "calc.y" /* yacc.c:1646  */
    { (yyval.arvore) = asd_new("inho"); (yyval.arvore)->value = (yyvsp[0].valor); }
